...
import '../../../../../../const.dart';
class ScreenInfoUser extends StatelessWidget {
var controllerivent= Get.put(IventsController());
    ScreenInfoUser({Key? key,required this.name,
    required this.email,required this.uid,
    required this.photoprofile,required this.phone,
     required this.wilaya, }) : super(key: key);
final name , email , uid,photoprofile, phone, wilaya  ;
  @override
...
const Spacer( flex: 2),
 ...
 Positioned(bottom: 0,left: 0,right: 0,
  ...
  Container sendpdf() {
   ...
   ),), child:     bottun(title: "See profile", color: const Color.fromARGB(255, 243, 107, 33), function: (){
