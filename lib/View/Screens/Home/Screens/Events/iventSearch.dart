...
class ScreenSearchIvent extends StatefulWidget {
  final tablename,docss;
   const ScreenSearchIvent({Key? key,required this.tablename,required this.docss}) : super(key: key);
  @override
  State<ScreenSearchIvent> createState() => _ScreenSearchIventState();
}
class _ScreenSearchIventState extends State<ScreenSearchIvent> {
