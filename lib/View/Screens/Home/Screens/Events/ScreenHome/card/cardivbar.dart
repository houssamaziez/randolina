...
Expanded(
  ...
  uid==items['uid']?  Get.to(
     EditIvent(
      ...
      nombresplaces:items["nombresplaces"] ,
      datedubte:items["datedubte"] ,
      datefine:items["datefine"] , 
      id:items["id"],
      ))
  ...
  :
   IconButton(
    onPressed: (){
     final controller= Get.put(IventsController());
    controller.seveevent(idpost:items['id'], list:items  ); },
